Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/cad5de5ba6e6cbc4ca0d0d9c6dcea09d"
{
	Properties
	{
		...
		_DissolveAlpha_GarterSocks1 ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DissolveAlpha_GarterSocks1;
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#endif
				float da = _DissolveAlpha_GarterSocks1
				+ (0.0 /*_DissolveAlpha0*/)
				+ (0.0 /*_DissolveAlpha1*/)
				+ (0.0 /*_DissolveAlpha2*/)
				+ (0.0 /*_DissolveAlpha3*/)
