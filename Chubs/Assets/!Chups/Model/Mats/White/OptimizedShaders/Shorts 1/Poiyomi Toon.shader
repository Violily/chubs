Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/529d210ffff242d49a93493beb5b3405"
{
	Properties
	{
		...
		_DissolveAlpha_Shorts1 ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#endif
				float da = _DissolveAlpha_Shorts1
				+ (0.0 /*_DissolveAlpha0*/)
				+ (0.0 /*_DissolveAlpha1*/)
				+ (0.0 /*_DissolveAlpha2*/)
				+ (0.0 /*_DissolveAlpha3*/)
