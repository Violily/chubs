Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/49ed3c66a468bed4d9ded004871b0141"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			)
			{
				...
				float lineWidth = (0.07 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_Matcap2SmoothnessEnabled*/))
				{
					...
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap2, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap2), matcap2Smoothness) * float4(poiThemeColor(poiMods, float4(1,0.04718075,0.04718075,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(1,0.04718075,0.04718075,1).a);
				}
				else
				{
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap2)) * float4(poiThemeColor(poiMods, float4(1,0.04718075,0.04718075,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(1,0.04718075,0.04718075,1).a);
				}
				#else
				matcap2 = float4(poiThemeColor(poiMods, float4(1,0.04718075,0.04718075,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(1,0.04718075,0.04718075,1).a);
				#endif
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.0 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), _Matcap2Mixed, (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, _Matcap2EmissionStrength, (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			#ifdef _SUNDISK_HIGH_QUALITY
			void applyFlipbook(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods)
			{
				...
				{
					flipBookPixel.rgb = hueShift(flipBookPixel.rgb, (0.0 /*_FlipbookHueShift*/) + _Time.x * (0.0 /*_FlipbookHueShiftSpeed*/), (0.0 /*_FlipbookHueShiftColorSpace*/));
				}
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor.rgb, customBlend(poiFragData.baseColor.rgb, flipBookPixel.rgb, (0.0 /*_FlipbookBlendType*/)), flipBookPixel.a * float4(1,1,1,1).a * _FlipbookReplace * flipBookMask * flipbookAlpha);
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				if ((0.0 /*_ScrollingEmission*/))
				{
					...
					{
						#if defined(PROP_EMISSIONSCROLLINGCURVE) || !defined(OPTIMIZER_ENABLED)
						emissionStrength0 *= UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionScrollingCurve, _MainTex, poiUV(poiMesh.uv[(0.0 /*_EmissionMapUV*/)], float4(1,1,0,0)) + (dot(pos, float4(0,-10,0,0).xyz) * (20.0 /*_EmissiveScroll_Interval*/)) + _Time.x * (5.0 /*_EmissiveScroll_Velocity*/)).r;
						#endif
					}
					else
					{
						emissionStrength0 *= calculateScrollingEmission(float4(0,-10,0,0).xyz, (5.0 /*_EmissiveScroll_Velocity*/), (20.0 /*_EmissiveScroll_Interval*/), (15.0 /*_EmissiveScroll_Width*/), (0.0 /*_EmissionScrollingOffset*/), pos);
					}
				}
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				for (int glitterLayer = 0; glitterLayer < (2.0 /*_GlitterLayers*/); glitterLayer++)
				{
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.622 /*_GlitterBias*/)), poiCam.viewDir)), (1000.0 /*_GlitterContrast*/)), 0);
						...
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (1000.0 /*_GlitterContrast*/)), 0);
			...
			{
				float smoothness = (0.642 /*_MochieRoughnessMultiplier*/);
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.1056116,0.03039392,0.03039392,1);
				#ifdef POI_AUDIOLINK
