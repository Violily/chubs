Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/2355bcf737fc99a4b968341c5f836204"
{
	Properties
	{
		...
		_DecalBlendAlpha_Eyeballs ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha_Eyeballs;
			...
			struct PoiDecal
			{
				...
				float m_DecalBlendAlpha_Eyeballs;
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_Eyeballs + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha_Eyeballs = _DecalBlendAlpha_Eyeballs;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.2603273,0.2603273,0.2603273,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.2603273,0.2603273,0.2603273,1).a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
