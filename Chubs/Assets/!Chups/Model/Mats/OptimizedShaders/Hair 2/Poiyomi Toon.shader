Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/694d0b9e14198f645b91ebca8a11388d"
{
	Properties
	{
		...
		_Color_Hair2 ("Color & Alpha--{reference_property:_ColorThemeIndex}", Color) = (1, 1, 1, 1)
		...
		[HideInInspector] s_start_MainHueShift_Hair2 ("Hue Shift--{reference_property:_MainHueShiftToggle,persistent_expand:true,default_expand:true}", Float) = 1
		...
		_MainHueShift_Hair2 ("Hue Shift", Range(0, 1)) = 0
		...
		[HideInInspector] s_end_MainHueShift_Hair2 ("Name Motion", Float) = 0
		...
		_DecalBlendAlpha_Hair2 ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			struct PoiDecal
			{
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_Hair2 + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha_Hair2 = _DecalBlendAlpha_Hair2;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.2 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, _Color_Hair2.rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * _Color_Hair2.a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				{
					float shift = _MainHueShift_Hair2;
					#ifdef POI_AUDIOLINK
