Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/fd38d5e04ad9fad4288869ac5621766e"
{
	Properties
	{
		...
		_DissolveAlpha_GarterSocks ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DissolveAlpha_GarterSocks;
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#endif
				float da = _DissolveAlpha_GarterSocks
				+ (0.0 /*_DissolveAlpha0*/)
				+ (0.0 /*_DissolveAlpha1*/)
				+ (0.0 /*_DissolveAlpha2*/)
				+ (0.0 /*_DissolveAlpha3*/)
			...
			void applyCubemap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				cubeMap.rgb *= poiThemeColor(poiMods, _CubeMapColor, (0.0 /*_CubeMapColorThemeIndex*/));
				#else
				float4 cubeMap = float4(0.21763764082, 0.21763764082, 0.21763764082, .5) * float4(poiThemeColor(poiMods, _CubeMapColor, (0.0 /*_CubeMapColorThemeIndex*/)), 1);
				#endif
				...
				if ((1.0 /*_CubeMapHueShiftEnabled*/))
				{
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (0.0 /*_GlitterFrequency*/);
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						if ((100.0 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (90.0 /*_GlitterAngleRange*/), (100.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
						...
						float brightness = (sin((_Time.x * 10 + randomOffset +glitterSpeedOffset) * (100.0 /*_GlitterSpeed*/)) * .5 + .5);
