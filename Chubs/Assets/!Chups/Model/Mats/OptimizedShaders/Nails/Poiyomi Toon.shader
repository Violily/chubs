Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/1d7fe16dad4934a49a10cebbed6707fd"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				#endif
				for (int glitterLayer = 0; glitterLayer < (4.0 /*_GlitterLayers*/); glitterLayer++)
				{
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (90.0 /*_GlitterAngleRange*/), (20.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
						...
						finalGlitter = lerp(0, (0.217 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.972 /*_GlitterBias*/)), poiCam.viewDir)), (925.0 /*_GlitterContrast*/)), 0);
						...
						finalGlitter = max((0.217 /*_GlitterMinBrightness*/) * glitterAlpha, brightness * glitterAlpha * smoothstep(0, 1, 1 - m_dist * (0.08 /*_GlitterCenterSize*/) * 10));
						break;
						case 2:
						if ((20.0 /*_GlitterSpeed*/) + glitterSpeedOffset > 0)
						{
						...
						finalGlitter = lerp(0, (0.217 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (925.0 /*_GlitterContrast*/)), 0);
			...
			{
				float smoothness = (0.572 /*_MochieRoughnessMultiplier*/);
				float smoothness2 = (1.0 /*_MochieRoughnessMultiplier2*/);
				float metallic = (0.652 /*_MochieMetallicMultiplier*/);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.1807606,0,0.0009029054,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.1807606,0,0.0009029054,1).a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
