Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/14fa4330955c3f94099637f4db7bcfc3"
{
	Properties
	{
		...
		_DissolveAlpha_Outfit ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#endif
				float da = _DissolveAlpha_Outfit
				+ (0.0 /*_DissolveAlpha0*/)
				+ (0.0 /*_DissolveAlpha1*/)
				+ (0.0 /*_DissolveAlpha2*/)
				+ (0.0 /*_DissolveAlpha3*/)
			...
			{
				float smoothness = (0.339 /*_MochieRoughnessMultiplier*/);
