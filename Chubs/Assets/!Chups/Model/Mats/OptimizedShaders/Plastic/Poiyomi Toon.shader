Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/3d15f90f1cff13e4a854f0cdfbcb59aa"
{
	Properties
	{
		...
		_DissolveAlpha_Plastic ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#endif
				float da = _DissolveAlpha_Plastic
				+ (0.0 /*_DissolveAlpha0*/)
				+ (0.0 /*_DissolveAlpha1*/)
				+ (0.0 /*_DissolveAlpha2*/)
				+ (0.0 /*_DissolveAlpha3*/)
			...
			{
				float smoothness = (0.616 /*_MochieRoughnessMultiplier*/);
