Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/d63a7114de6e4b04db92114de03e38e1"
{
	Properties
	{
		...
		_DissolveAlpha_KnittedTop ("Dissolve Alpha", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DissolveAlpha_KnittedTop;
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, inout PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#endif
				float da = _DissolveAlpha_KnittedTop
				+ (0.0 /*_DissolveAlpha0*/)
				+ (0.0 /*_DissolveAlpha1*/)
				+ (0.0 /*_DissolveAlpha2*/)
				+ (0.0 /*_DissolveAlpha3*/)
